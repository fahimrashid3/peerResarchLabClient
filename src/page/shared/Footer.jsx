  ...
  return (
    <footer className="footer bg-primary-900 text-neutral-content p-10">
      ...
      <nav>
        ...
        <Link to={"/publications"} className="footer-title">Publications</Link>
        <Link to={"/team"} className="footer-title">Team</Link>
        <Link to={"/contact"} className="footer-title">Contact Us</Link>
        </div>
...
//     <footer className="footer bg-dark-700 footer-horizontal footer-center bg-primary text-primary-content p-10">
//   <aside>
//     <svg
//       width="50"
//       height="50"
