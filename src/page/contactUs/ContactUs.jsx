  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 p-2 md:p-5 lg:p-10 text-gray-800 dark:text-gray-100">
      ...
      <div className="mt-6 md:mt-10 bg-gray-200 dark:bg-gray-900 p-2 md:p-5 lg:p-10 max-w-7xl mx-auto justify-center">
        ...
        <div className="py-5 md:py-14 lg:py-20 space-y-5 flex flex-col-reverse md:flex-row-reverse gap-4 md:gap-6">
          <div className="flex-1 mt-2 md:mt-0 dark:bg-gray-950 bg-gray-100 rounded-2xl shadow-xl p-2 md:p-5 border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex-1">
            <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-xl p-2 md:p-5 border border-gray-200 dark:border-gray-700 h-full">
