const AboutPageDesignRevers = ({ data }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row-reverse justify-around items-center md:max-w-[90%] lg:max-w-[85%] mx-auto gap-5 bg-dark-200 dark:bg-dark-900 p-5 rounded-lg md:rounded-xl">
